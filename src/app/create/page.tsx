              ...
              <Card className="h-full border-2 border-blue-200 hover:border-blue-300 transition-all duration-300 hover:shadow-xl group cursor-pointer">
                <Link href={ROUTES.CREATE.RESTAURANT}>
                  <CardHeader className="text-center pb-4">
                    ...
                    <CardTitle className="text-2xl text-blue-900">Restaurant</CardTitle>
                    <p className="text-blue-700">For restaurants, cafes, and food businesses</p>
                  </CardHeader>
              ...
              <Card className="h-full border-2 border-purple-200 hover:border-purple-300 transition-all duration-300 hover:shadow-xl group cursor-pointer">
                <Link href={ROUTES.CREATE.CREATOR}>
                  <CardHeader className="text-center pb-4">
                    ...
                    <CardTitle className="text-2xl text-purple-900">Creator</CardTitle>
                    <p className="text-purple-700">For artists, musicians, streamers, and content creators</p>
                  </CardHeader>
            ...
            <div className="grid md:grid-cols-3 gap-6">
              <Card className="text-center border-0 shadow-lg bg-white/80 backdrop-blur-sm">
                <CardContent className="p-6">
                  ...
                  <p className="text-gray-600">Set up your profile in under 30 seconds with just your wallet address</p>
                </CardContent>
              </Card>
              ...
              <Card className="text-center border-0 shadow-lg bg-white/80 backdrop-blur-sm">
                <CardContent className="p-6">
                  ...
                  <p className="text-gray-600">Built on Aptos blockchain with Google authentication for maximum security</p>
                </CardContent>
              </Card>
              ...
              <Card className="text-center border-0 shadow-lg bg-white/80 backdrop-blur-sm">
                <CardContent className="p-6">
                  ...
                  <p className="text-gray-600">Receive tips from anywhere in the world, instantly and fee-free</p>
                </CardContent>
              </Card>
            </div>
          </motion.div>
              ...
              <Card className="border-0 shadow-lg bg-gradient-to-br from-blue-50 to-blue-100">
                <CardContent className="p-6">
                  <div className="flex items-center space-x-4 mb-4">
                    ...
                    <div>
                      <h3 className="font-semibold">Mario's Pizza</h3>
              ...
              <Card className="border-0 shadow-lg bg-gradient-to-br from-purple-50 to-purple-100">
                <CardContent className="p-6">
                  <div className="flex items-center space-x-4 mb-4">
                    ...
                    <div>
                      <h3 className="font-semibold">Alice Sterling</h3>
                      <div className="flex items-center space-x-1 text-sm text-gray-600">
